...
public class BoundaryAfficherMarche {
	...
	public void afficherMarche(String nomAcheteur) {
		...
		if (infosMarche.length == 0) {
			...
			StringBuilder msgAAcheteur = new StringBuilder();
			msgAAcheteur.append(nomAcheteur);
			msgAAcheteur.append(", vous trouverez au marché:");
			System.out.println(msgAAcheteur.toString());
